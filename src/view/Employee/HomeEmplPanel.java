...
public class HomeEmplPanel extends JPanel {
	...
	public HomeEmplPanel() {
		...
		lblNewLabel_1.setFont(new Font("Book Antiqua", Font.PLAIN, 96));
		lblNewLabel_1.setText("<html><div style='text-align: center;'>Hệ thống quản lí<br>vé - Khách hàng</div></html>");
